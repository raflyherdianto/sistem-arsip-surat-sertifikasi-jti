        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Kategori Arsip Surat</h3>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="/dashboard">Dashboard</a></li>
                            <li class="breadcrumb-item active" aria-current="page">Edit Kategori Arsip</li>
                        </ol>
                    </nav>
                </div>
            </div>
            <div class="col-md-30 col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-horizontal" action="/dashboard/kategori-arsip/{{ $kategori->id }}" method="POST">
                                @method('put')
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            <input type="text" id="kode_kategori"
                                                ...
                                                name="kode_kategori" value="{{ old('kode_kategori', $kategori->kode_kategori) }}" readonly>
                                            @error('kode_kategori')
