        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    ...
                    <p class="text-subtitle text-muted">Edit surat yang telah terbit pada form ini untuk diarsipkan.
            ...
            <div class="col-md-30 col-12">
                <div class="card">
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-horizontal" action="/dashboard/arsip/{{ $surat->id }}" method="POST" enctype="multipart/form-data">
                                @method('put')
                                @csrf
                                <div class="form-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 form-group">
                                            ...
                                            name="kategori_surat_id">
                                                ...
                                                @foreach ($kategoris as $kategori)
                                                    @if (old('kategori_surat_id', $kategori->id) == $surat->kategori_surat_id)
